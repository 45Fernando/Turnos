defmodule Turnos.RolesTest do
  ...
  describe "roles" do
    ...
    @valid_attrs %{nameRole: "some nameRole"}
    @update_attrs %{nameRole: "some updated nameRole"}
    ...
    test "create_role/1 with valid data creates a role" do
      ...
      assert role.nameRole == "some nameRole"
    end
    ...
    test "update_role/2 with valid data updates the role" do
      ...
      assert role.nameRole == "some updated nameRole"
    end
